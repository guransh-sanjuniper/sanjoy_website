/**
 * BACKUP — Pre-Calendly Book Discovery route page.
 * This file was unchanged by the Calendly integration; preserved for reference.
 *
 * DO NOT IMPORT. Reference / rollback copy only.
 * Active version: app/book-discovery/page.tsx
 */
